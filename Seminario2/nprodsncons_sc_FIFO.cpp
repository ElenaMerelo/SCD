...
//
// archivo: nprodancons_sc_FIFO.cpp
...
// *****************************************************************************
// clase para monitor buffer, version FIFO, semántica SC, n prod. y n cons.
...
void funcion_hebra_productora( ProdConsNSC * monitor ){
  int valor;
   for( unsigned i = 0 ; i < num_items ; i++ ){
      valor = producir_dato() ;
...
void funcion_hebra_consumidora( ProdConsNSC * monitor ){
    int valor;
   for( unsigned i = 0 ; i < num_items ; i++ ){
      valor = monitor->leer();
      consumir_dato( valor ) ;
...
int main(){
  int nprods, ncons, i;
   cout << "-------------------------------------------------------------------------------" << endl
        << "Problema de los productores-consumidores (n prod/cons, Monitor SC, buffer FIFO). " << endl
        << "-------------------------------------------------------------------------------" << endl
        << flush ;
