...
class ProdCons1SC{
 ...
 int                        // variables permanentes
   ...
   primera_ocupada,         // primera celda ocupada en el vector. Se incrementa al leer
...
int ProdCons1SC::leer(  ){
   ...
   if ( num_celdas_ocupadas_buffer == 0 )
...
void ProdCons1SC::escribir( int valor ){
   ...
   if ( num_celdas_ocupadas_buffer == num_celdas_total )
      libres.wait( guarda );
